...
public class MainActivity extends AppCompatActivity {
    ...
    public class FetchWeatherData extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            URL weather_URL = NetworkUtils.buildUrl(location);

            try {
                String weather_results_raw = NetworkUtils.getResponseFromHttpUrl(weather_URL);
                String[] weather_results_formatted =
                        OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,
                                weather_results_raw);
                return weather_results_formatted;
            } catch (Exception e) {
                e.printStackTrace();
                return null;
            }
        ...
        protected void onPostExecute(String[] results) {
            if (results != null) {
                for (String weather_string : results) {
                    mWeatherTextView.append(weather_string);
                }
            }
        }
